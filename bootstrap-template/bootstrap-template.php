...
<div class="jumbotron text-center section-class-name" data-section-name="home">
    <h1>Company</h1>
    ...
    <div class="row">
        <div class="col-sm-8">
            ...
            <h4>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</h4><br>
...
<div class="container-fluid bg-grey">
    <div class="row">
        ...
        <div class="col-sm-8">
            <h2>Our Values</h2><br>
            <h4><strong>MISSION:</strong> Our mission lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
                aliquip ex ea commodo consequat.</h4><br>
            <p><strong>VISION:</strong> Our vision Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
...
<div id="contact" class="container-fluid bg-grey section-class-name" data-section-name="contact">
...
<footer class="container-fluid text-center" style="color:white; background-color: #333; margin-bottom: 60px">
